...
public class DatabaseHelper
{
    ...
    //public void SaveNewSchools(List<NewSchool> newSchools)
    //{
    //    using (var connection = new NpgsqlConnection(_connectionString))
    //    {
    //        connection.Open();
    ...
    //                    KodPocztowy, SubFieldKodPocztowy, NumerBudynku, SubFieldNumerBudynku, Email, SubFieldEmail, 
    //                    Ulica, SubFieldUlica, Poczta, SubFieldPoczta, Telefon, SubFieldTelefon, NumerLokalu, SubFieldNumerLokalu, 
    ...
    //                    KodTerytorialnyMiejscowosc, SubFieldKodTerytorialnyMiejscowosc, KodTerytorialnyWojewodztwo, 
    //                    SubFieldKodTerytorialnyWojewodztwo, OrganProwadzacyWojewodztwo, SubFieldOrganProwadzacyWojewodztwo,
    //                    DataRozpoczeciaDzialalnosci, SubFieldDataRozpoczeciaDzialalnosci, isDiferentObj, isNewObj
    //                ) VALUES (
    //                    @RspoNumer, @SubFieldRspoNumer, @Longitude, @SubFieldLongitude, @Latitude, @SubFieldLatitude, @Typ, 
    //                    @SubFieldTyp, @Nazwa, @SubFieldNazwa, @Miejscowosc, @SubFieldMiejscowosc, @Wojewodztwo, @SubFieldWojewodztwo, 
    //                    @KodPocztowy, @SubFieldKodPocztowy, @NumerBudynku, @SubFieldNumerBudynku, @Email, @SubFieldEmail, 
